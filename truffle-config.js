...
//These are needed to be able to connect to Rinkeby using Infura
const HDWalletProvider = require('truffle-hdwallet-provider');
const infuraKey = "c2974956d85e4a07bd3109a5679c0cf9";
...
module.exports = {
  ...
  networks: {
    ...
    // this is to make sure we can deploy to Rinkeby network as per the Rubric
    rinkeby: {
