...
import "../build/contracts/ERC721/ERC721.sol";
...
contract StarNotary is ERC721 {
    ...
    string public constant symbol = "UDC"; // my symbol
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address owner1 = ownerOf(_tokenId1);    //first owner
        address owner2 = ownerOf(_tokenId2);    //second owner
        require(owner1 == msg.sender || owner2 == msg.sender, "Exchange only possible for owners!");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "Only owner of a star can transfer it!");
